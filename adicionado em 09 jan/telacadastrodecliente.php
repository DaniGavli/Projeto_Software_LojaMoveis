...
<html>
  ...
  label {color: 00BFFF; font-size:15px; margin-right: 8px;}
  input{ width:180px; height: 20px; margin-top: 3px; margin-left: 20px;}
  #btn {width:150px; height: 35px; margin-top: 6px; margin-left: 20%; background-color: #FFFFFF; color: #00BFFF; border: none;}
         ...
         <div>
           <?php
            if (isset($_GET['erro'])) {
              ...
              ?>
              <p>Erro identificado no campo <?=$erro?></p>
              <?php
            }
           ?>
 <form id="cadForm" action="salva-cliente.php" method="post">
 <label><h1>Cadastro de Cliente</h1></label>
